...
function next() {
    if (clickRef) clickRef.textContent = keys[currentKeyIndex];
}
next();
window.addEventListener('keydown', (event)=>{
    ...
    } else if (event.key.length === 1) (0, _pnotifyJs.error)({
        title: "\u041F\u043E\u043C\u0438\u043B\u043A\u0430!",
        text: `\u{41D}\u{430}\u{442}\u{438}\u{441}\u{43D}\u{456}\u{442}\u{44C} "${target}"`,
        delay: 1000
    });
});
const ctx = document.getElementById('myChart');
